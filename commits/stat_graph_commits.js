...
(function() {
  this.CommitsStatGraph = (function() {
    function CommitsStatGraph() {}

    CommitsStatGraph.prototype.init = function(log) {
      var author_commits, total_commits;
      this.parsed_log = CommitsStatGraphUtil.parse_log(log);
      this.set_current_field("commits");
      total_commits = CommitsStatGraphUtil.get_total_data(this.parsed_log, this.field);
      author_commits = CommitsStatGraphUtil.get_author_data(this.parsed_log, this.field);
      this.add_master_graph(total_commits);
      this.add_authors_graph(author_commits);
      return this.change_date_header();
    };

    CommitsStatGraph.prototype.add_master_graph = function(total_data) {
      this.master_graph = new ContributorsMasterGraph(total_data);
      return this.master_graph.draw();
    };

    CommitsStatGraph.prototype.add_authors_graph = function(author_data) {
    ...
    CommitsStatGraph.prototype.format_author_commit_info = function(author) {
    ...
    CommitsStatGraph.prototype.format_author_meta_info = function(author) {
    ...
    CommitsStatGraph.prototype.format_author_rank_info = function(author, rank) {
      var author_rank;
      author_rank = $('<span/>', {
        "class": 'rank'
      });
    ...
    CommitsStatGraph.prototype.create_author_header = function(author, rank) {
    ...
    CommitsStatGraph.prototype.redraw_master = function() {
      var total_data;
      total_data = CommitsStatGraphUtil.get_total_data(this.parsed_log, this.field);
      this.master_graph.set_data(total_data);
      return this.master_graph.redraw();
    };

    CommitsStatGraph.prototype.redraw_authors = function() {
      var author_commits, x_domain, _this;
      _this = this;
      $("ol").html("");
      x_domain = ContributorsGraph.prototype.x_domain;
      author_commits = CommitsStatGraphUtil.get_author_data(this.parsed_log, this.field, x_domain);
    ...
    CommitsStatGraph.prototype.set_current_field = function(field) {
      return this.field = field;
    };

    CommitsStatGraph.prototype.change_date_header = function() {
    ...
    CommitsStatGraph.prototype.redraw_author_commit_info = function(author, rank) {
