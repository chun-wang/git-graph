...
(function() {
  window.ContributorsStatGraphUtil = {
    parse_log: function(log) {
      var by_author, entry, i, len, total;
      total = {};
      by_author = {};
    ...
    add_author: function(author, by_author) {
      ...
      by_author[author.author_name].author_avatar = author.author_avatar;
    ...
    parse_log_entry: function(log_entry, field, date_range) {
      ...
      parsed_entry.author_avatar = log_entry.author_avatar;
      parsed_entry.dates = {};
      parsed_entry.commits = parsed_entry.additions = parsed_entry.deletions = 0;
      _.each(_.omit(log_entry, 'author_name', 'author_email','author_avatar'), (function(_this) {
