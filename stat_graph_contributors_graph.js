...
(function() {
  ...
  this.ContributorsAuthorGraph = (function(superClass) {
    ...
    function ContributorsAuthorGraph(data1) {
      this.data = data1;
      this.width = $('.container').width() / 2 - 125;
      this.height = 150;
      this.x = null;
      this.y = null;
      this.x_axis = null;
    ...
    ContributorsAuthorGraph.prototype.create_svg = function() {
      ...
      return this.svg = d3.select(this.list_item).append("svg").attr("width", this.width + this.MARGIN.left + this.MARGIN.right).attr("height", this.height + this.MARGIN.top + this.MARGIN.bottom).attr("class", "capped-card-content").append("g").attr("transform", "translate(" + this.MARGIN.left + "," + this.MARGIN.top + ")");
    };
